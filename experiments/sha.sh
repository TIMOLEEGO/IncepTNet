#!/usr/bin/env bash
python -m torch.distributed.launch --nproc_per_node=1 --master_port 3018 train_distributed_no.py --gpu_id '1' \
...
--dataset sha --crop_size 256 --pre None --test_patch --save