...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
        ...
        self.self_attn_CAB = CAB(d_model)
    ...
    def forward_post(self,
        ...
        src_cab=self.self_attn_CAB(x)
        # print("通道1",src_cab.shape)
        src_cab = src_cab.flatten(2).permute(2, 0, 1)
        # print("src",src.shape)
        # print("多头",src2.shape)
        # print("通道2",src_cab.shape)
        src = src + self.dropout1(src2)+self.dropout1(src_cab)
        src = self.norm1(src)
